...
<!-- Home Banner -->
<section id="homeHero" class="home-hero-section bg-dark text-secondary py-5 text-center">
	<div class="container py-5">
		<div class="row">
			<div class="col-md-8 col-lg-6 mx-auto">
				<span class="text-light">Welcome to the</span>
				<h1 class="display-5 fw-bold text-uppercase text-white">Catalog Site</h1>
				<p class="fs-5 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam in nunc purus. Cras ut tempus diam, nec convallis mauris. Etiam a mollis odio.</p>
				<div class="d-grid gap-2 d-sm-flex justify-content-center">
					<a href="./products.html" class="btn btn-outline-primary btn-lg fw-bold">Explore Our Products</a>
				</div>
			</div>
		</div>
	</div>
